...
const BlogCard = ({ imageUrl, title, authorName, authorImageUrl, date }) => (
  <div className="bg-black  overflow-hidden shadow-2xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-3 group border border-gray-100 h-full flex flex-col">
    {/* Larger Image Container - Full width and taller */}
    <div className="relative overflow-hidden h-80 sm:h-96 lg:h-[400px] flex-shrink-0">
      <img
        src={imageUrl}
        alt={title}
        className="w-full h-full sm:h-80 object-cover transition-transform duration-700 group-hover:scale-105"
      />
    ...
    <div className="p-6 sm:p-8 bg-white flex-grow flex items-center">
      <div className="flex items-center gap-4 w-full">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-base sm:text-lg font-bold text-gray-900 truncate">{authorName}</p>
...
const ChallengeCard = ({ challenge }) => {
  ...
  return (
    <div className="group bg-white border p-4 sm:p-6 mb-6 sm:mb-10 pb-6 sm:pb-25 rounded-lg text-center hover:shadow-lg transition-transform duration-300">
      ...
      <p className="text-black font-semibold mt-4 text-sm sm:text-base">{challenge.text}</p>
    </div>
  );
};
...
const blogPosts = [
  {
    ...
    title: "A Week in the Life of Isla, Our Work Experience Student",
    authorName: "Isla",
    authorImageUrl: "https://i.pravatar.cc/40?u=isla",
  },
  {
    id: 2,
    ...
    authorName: "Morgan",
    authorImageUrl: "https://i.pravatar.cc/40?u=morgan",
  },
  {
    id: 3,
...
function InsightsSection() {
  ...
  // Define custom page ranges for overlapping content
  const pageRanges = [
    [0, 3],
    [3, 6], 
    [4, 7]  
          ...
          >
            {pageRanges.map((range, pageIndex) => (
              <div key={pageIndex} className="w-full flex-shrink-0">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 p-1">
                  {blogPosts
  ...
  return (
    <>
      ...
      <section className="relative flex flex-col justify-center min-h-screen overflow-hidden">
        ...
        <div className="relative lg:mr-160  z-10 max-w-2xl mx-4 lg:mx-auto lg:pl-9">
          <p className="text-sm sm:text-base lg:text-lg font-bold text-white mb-4 lg:mb-5 lg:pt-5 lg:mt-15 mt-8 text-center lg:text-left">
            WE ARE REFLECT DIGITAL
          </p>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold leading-tight mb-4 lg:mb-6 text-white  text-center lg:text-left">
            UNLEASH <p>
              </p>YOUR DIGITAL PERFORMANCE.
          </h1>
          <div className="text-center lg:text-left">
            <button className="border-2 border-white text-white px-6 sm:px-8 py-2 sm:py-3 lg:ml- mt-8 lg:mt-16 rounded-full font-semibold text-sm sm:text-base hover:bg-white hover:text-[#fc1974] transition-colors duration-300">
              OUR WORK
            </button>
          </div>
        </div>
      ...
      <section className="w-full bg-[#cfcfcf] py-12 sm:py-16 lg:py-20">
            ...
            <div className="text-center lg:text-left order-1 lg:order-2">
              ...
              <div className="mt-6 sm:mt-8 space-y-4">
                ...
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                  ...
                  creativity and technology to work smarter, not harder to elevate
                  your digital marketing efforts.
                </p>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                  Our team leverage their expertise to tackle your business
                  challenges. Our strategic approach will ensure your business and
                  audience needs are met with the right combination of channels
                  and creativity.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6 sm:gap-8 lg:gap-16">
            ...
            <div className="relative z-10 order-2 lg:order-1 text-center lg:text-left">
              ...
              <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4">
                <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  ...
                  factors that influence purchase decisions. Our approach delivers
                  high return on investment by making sure your budget is spent
                  where maximum impact can be achieved.
                </p>
                <p className="text-sm sm:text-base lg:text-lg text-gray-700 leading-relaxed max-w-xl mx-auto lg:mx-0">
                  Strategic thinking allows us to see past channels as solutions
                  and instead delve deeper into your organisation's challenges and
                  how our experts can help you solve them.
                </p>
              </div>
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative aspect-[3/4] rounded-l-[2rem] sm:rounded-l-[3rem] lg:rounded-l-[5rem] overflow-hidden shadow-lg sm:shadow-xl lg:shadow-2xl">
                <img
                  src="/audaince.png"
