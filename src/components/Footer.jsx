...
return ( <section className="bg-black text-center flex flex-col justify-start items-center relative py-16 md:py-44">
{/* Heading */} <h2 className="text-white text-3xl md:text-4xl xl:text-5xl font-extrabold mb-8">
HAVE A PROJECT YOU <br /> WOULD LIKE TO DISCUSS? </h2>
  ...
  <div className="flex justify-center gap-6 mt-8 text-white text-sm flex-wrap">  
    <span className="text-gray-400 cursor-pointer">Terms of Service</span>  
    <span className="text-gray-400 cursor-pointer">Certificate</span>  
    <span className="text-gray-400 cursor-pointer">FAQs</span>  
    {/* Contact link opens SupportModal */}  
    <span className="text-gray-400 cursor-pointer" onClick={onSupportClick}>Contact</span>  
